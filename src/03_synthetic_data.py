...
def main():
    ...
    keyword_rules = {
        ...
        "data mining": ["mining", "pattern discovery"],
        ...
        "database systems": ["database", "dbms", "transaction"],
        "distributed systems": ["distributed", "parallel", "cluster"],
        ...
        "data integration": ["integration", "schema matching"],
        "query processing": ["query", "join", "execution plan"],
